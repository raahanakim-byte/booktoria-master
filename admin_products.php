...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
     ...
     "INSERT INTO `products`(name, author, genre, price, image, location) 
     VALUES('$name', '$author', '$genre', '$price', '$image', '$location')"
     ) or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="location" class="box" placeholder="enter location" required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="genre">Genre: <?php echo $fetch_products['genre']; ?></div>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_author" value="<?= $fetch_update['author']; ?>" class="box" required>
      <input type="text" name="update_genre" value="<?= $fetch_update['genre']; ?>" class="box" required>
      <input type="text" name="update_location" value="<?= $fetch_update['location']; ?>" class="box" required>
